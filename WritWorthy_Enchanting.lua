...
Enchanting.POTENCY_RUNES = {
  [ADD] = {
    [CP150] = Enchanting.REJERA,
    [CP160] = Enchanting.REPORA
  },
  [SUB] = {
    [CP150] = Enchanting.JEHADE,
...
function Parser:ParseItemLink(item_link)
  ...
  if
  not (self.glyph and self.glyph.add_sub and Enchanting.POTENCY_RUNES[self.glyph.add_sub] and level_num and
    Enchanting.POTENCY_RUNES[self.glyph.add_sub][level_num] and
    quality_num and
    Enchanting.ASPECT_RUNES[quality_num])
  then
...
function Parser:ToDolRequest(unique_id)
  ...
  return {
    ["function"] = "CraftEnchantingItemId",
    ["args"] = o
  }
end
