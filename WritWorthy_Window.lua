...
function WritWorthyUI_SavePos()
  -- 2019-12-20 can dead code strip
...
function WritWorthyInventoryList:GetLLC()
  ...
  if llc_global and llc_global.craftInteractionTables then
    ...
    self.LibLazyCrafting.GetCurrentSetInteractionIndex = llc_global.functionTable.GetCurrentSetInteractionIndex
  end
  -- if      llc_global
...
function WritWorthyInventoryList.SaveChariableState(unique_id, state)
  WritWorthy.savedChariables.writ_unique_id = WritWorthy.savedChariables.writ_unique_id or {}
  WritWorthy.savedChariables.writ_unique_id[unique_id] = WritWorthy.savedChariables.writ_unique_id[unique_id] or {}
